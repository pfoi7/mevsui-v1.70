...
// IPC client for talking to a co-located patched fullnode over a Unix
// domain socket. Used by the sui-mev arb bot to dry-run transactions
// against a local cache without paying HTTP RTT. Originally ported from
// the suiflow/mevsui fork (rev 7c6a455a) for Sui mainnet-v1.70+.
